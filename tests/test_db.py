            ...
            for metric, value in histograms_template.iteritems():
                ...
                for metric, _dict in keyed_scalars_template.iteritems():
                    for key, value in _dict.iteritems():
                        ...
                        metric_name = '{}_{}_{}'.format(numeric_scalars_prefix, metric.upper(), key.upper())
                        test_numeric_scalar("build_id", channel, version, template_build_id, metric_name, value, expected_count) 
        ...
        for version in template_version:
            ...
            for metric, _dict in keyed_scalars_template.iteritems():
                for key, value in _dict.iteritems():
                    ...
                    metric_name = '{}_{}_{}'.format(numeric_scalars_prefix, metric.upper(), key.upper())
                    test_numeric_scalar("submission_date", channel, version, template_submission_date, metric_name, value, expected_count) 
